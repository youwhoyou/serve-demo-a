...
import { Box, Center, Container, Text, Icon, useColorModeValue, Button, Stack, useDisclosure, Heading, Input, InputGroup, useToast } from "@chakra-ui/react";
            ...
            <Box p={[3, 4, 6, 8]} pt={["15%", "100px", "100px", "100px"]}>
                <Container minHeight="200px" maxW="lg" borderRadius="xl" p="0" overflow="hidden">
                    <Box px="6" pb="0" pb="4" pt="4" bg="gray.10" >
                        <Text fontSize={["8vw", "4xl", "4xl", "4xl"]} fontWeight="500" color="primary.500">Faucet</Text>
                        <Text fontSize={["4vw", "md", "md", "md"]}>Send mock $YOU and $USD tokens to your Avalance C-Chain wallet address for use with the <Text as="span" fontSize={["6vw", "2xl", "2xl", "2xl"]} color="gray.700">Serve Demo</Text></Text>
                    </Box>
                    <Stack px="5" pt="4" pb="8" align="center" spacing="4" w="100%" >
                        <Stack pb="3" spacing="2" w="100%">
                            <InputGroup size='lg'>
                                <Input isDisabled={isLoading} placeholder='enter your Avalance Fuji C-Chain address' onChange={e => setAddress(e.target.value)} />
                            </InputGroup>
