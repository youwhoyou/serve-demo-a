...
export default function TimeDayPicker({ disableEdit, dayTime, setDayTime }) {
    ...
    const handleAddTimeDay = () => {
        ...
        if (arr.length <= 3) {
            ...
            setNewServiceError(["Max. Day Time Reached", "Too many instances of Day and Time, max. 3 allowed."]);
            setShowAlert(true);
        }
    }
        ...
        <>
            ...
            {!disableEdit &&
                <Flex justify="flex-end" px={1} align="center">
                    ...
                    {dayTimeSaved ?
                        <Text color="green.300" as="i" fontSize="13px" mr={3}><Icon as={TiI.TiTick} fontSize="16px" mb="3px" />saved</Text>
                        :
                        <Text color="primary.300" as="i" fontSize="13px" mr={3}>click to save dates & times <Icon as={BsI.BsArrowRightShort} /></Text>
                    }
